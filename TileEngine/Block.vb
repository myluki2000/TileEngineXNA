...
Public Class Block
    ...
    Public Sub New(_position As Vector2, _solid As Boolean, _texture As Texture2D, _castShadows As Boolean) ' block
        Position = _position
        Solid = _solid
    ...
    Public Sub New(_position As Vector2, _solid As Boolean, _texture As Texture2D, _boundingbox As Rectangle, _castShadows As Boolean) ' Model based
        Position = _position
        Solid = _solid
        SpriteTexture = _texture
        rect = New Rectangle(CInt(Position.X * BlockWidth), CInt(Position.Y * BlockWidth) + BlockWidth, BlockWidth, BlockWidth)
